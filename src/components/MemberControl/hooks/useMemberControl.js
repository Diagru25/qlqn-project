...
const userValidSchema = Yup.object().shape({
  userBasicFormValue: Yup.object().shape({
    ...
    NgayXuatNgu: Yup.string().required("Yêu cầu nhập thông tin!"),
    NgayTaiNgu: Yup.string().required("Yêu cầu nhập thông tin!"),
  ...
  userCorporateFormValue: Yup.object().shape({
    NgayVaoDang: Yup.string().required("Yêu cầu nhập thông tin!"),
    NoiVaoDang: Yup.string().trim().required("Yêu cầu nhập thông tin!"),
    NgayVaoDangChinhThuc: Yup.string().required("Yêu cầu nhập thông tin!"),
    NgayVaoDoan: Yup.string().required("Yêu cầu nhập thông tin!"),
    ChucVuDang: Yup.string().trim().required("Yêu cầu nhập thông tin!"),
